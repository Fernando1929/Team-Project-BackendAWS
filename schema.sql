...
CREATE TABLE seller (seller_id serial primary key, user_id integer references users(user_id));
...
CREATE TABLE sells (resource_id integer references resources(resource_id), seller_id integer references
seller(seller_id), primary key (resource_id, seller_id));

CREATE TABLE has (resource_id integer references resources(resource_id), faction_id integer references
