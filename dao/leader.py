...
class LeaderDAO:
    ...
    def getAllLeaders(self):
        ...
        query = "select user_id, Leader_id, user_firstname, user_lastname, user_date_birth, user_email, phone_id, user_phone from Leader natural inner join users natural inner join user_phone;"
    ...
    def getLeaderById(self, Leader_id):
        cursor = self.cnx.cursor()
        query = "select user_id, Leader_id, user_firstname, user_lastname, user_date_birth, user_email, phone_id, user_phone from Leader natural inner join users natural inner join user_phone where Leader_id = %s;"
